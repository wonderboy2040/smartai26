...
export const initialETFs: ETF[] = [
  // --- INDIA ETFs ---
  { id: '1', symbol: 'JUNIORBEES', name: 'Nippon India Junior BeES', price: 812.45, prevPrice: 812.45, change: 12.30, changePercent: 1.54, volume: '3.8M', marketCap: '₹4,521Cr', market: 'IN', signal: 'BUY', confidence: 88, rsi: 58, macd: 'Bullish', trend: 'Uptrend', support: 790.00, resistance: 840.00, holdings: 0 },
  { id: '2', symbol: 'MID150BEES', name: 'Nippon India Midcap 150', price: 185.20, prevPrice: 185.20, change: 2.15, changePercent: 1.17, volume: '1.2M', marketCap: '₹1,200Cr', market: 'IN', signal: 'BUY', confidence: 82, rsi: 60, macd: 'Bullish', trend: 'Uptrend', support: 180.00, resistance: 195.00, holdings: 0 },
  { id: '3', symbol: 'SMALLCAP', name: 'Nippon India Small Cap', price: 145.60, prevPrice: 145.60, change: 3.40, changePercent: 2.39, volume: '2.5M', marketCap: '₹2,100Cr', market: 'IN', signal: 'HOLD', confidence: 68, rsi: 65, macd: 'Neutral', trend: 'Sideways', support: 135.00, resistance: 155.00, holdings: 0 },
  { id: '4', symbol: 'MOMOMENTUM', name: 'Motilal Oswal Momentum', price: 210.45, prevPrice: 210.45, change: 4.20, changePercent: 2.04, volume: '800K', marketCap: '₹850Cr', market: 'IN', signal: 'BUY', confidence: 91, rsi: 70, macd: 'Bullish', trend: 'Strong Uptrend', support: 200.00, resistance: 225.00, holdings: 0 },
